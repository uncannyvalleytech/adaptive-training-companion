    ...
    return html`
      <div id="home-screen" class="container">
        ...
        <nav class="home-nav-buttons">
          ...
          <button class="hub-option card-interactive" @click=${() => this._handleChangeView({ detail: { view: 'templates' }})}>
            <div class="hub-option-icon">📖</div>
            <div class="hub-option-text">
              <h3>Templates</h3>
          ...
          <button class="hub-option card-interactive" @click=${() => this._handleChangeView({ detail: { view: 'history' }})}>
            <div class="hub-option-icon">📊</div>
            <div class="hub-option-text">
              <h3>Progress</h3>
          ...
          <button class="hub-option card-interactive" @click=${() => this._handleChangeView({ detail: { view: 'achievements' }})}>
            <div class="hub-option-icon">🏆</div>
            <div class="hub-option-text">
              <h3>Achievements</h3>
              <p>Unlock rewards</p>
        ...
        <!-- Settings Button -->
        <button class="btn btn-icon" @click=${() => this._handleChangeView({ detail: { view: 'settings' }})} aria-label="Settings" style="position: absolute; bottom: 2rem; right: 2rem;">
